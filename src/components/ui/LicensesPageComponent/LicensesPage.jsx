    ...
    <div className="licenses-container">
      ...
      <div className="main-license">
        <div className="license-info">
          <h2>Госпромнадзор МЧС Республики Беларусь</h2>
        ...
        <div className="documents-grid">
          <div className="document-card">
            ...
            <div className="document-content">
              ...
              <p>Сертификат соответствия требованиям международного стандарта СТБ ISO 9001-2015 (ISO 9001:2015, IDT). Подтверждает, что система менеджмента качества компании соответствует международным стандартам.</p>
          ...
          <div className="document-card">
            ...
            <div className="document-content">
              ...
              <p>Документ содержит рекомендации компаний-заказчиков для СООО «БИК СЗМА», подтверждающие своевременное выполнение работ на высоком профессиональном уровне с соблюдением проектной документации и выражение заинтересованности в партнерстве.</p>
              <div className="document-details">
                <div className="detail">
                  <span>Формат:</span> PDF
                </div>
