...
const LearningPage = () => {
    ...
    const learning = [
        ...
        { id: 2, title: "Выписка из журнала учёта присвоения (подтверждения) электротехническому персоналу групны по электробезопасности", imageUrl: "/images/learning_docs/11_01_25.jpg", date: "2025-01-11" },
        { id: 3, title: "Выписка из журнала учёта присвоения (подтверждения) электротехническому персоналу групны по электробезопасности", imageUrl: "/images/learning_docs/11_01_25(2).jpg", date: "2025-01-11" },
        ...
        { id: 5, title: "Свидетельство о повышении квалификации C Nº 4303412 по эксппуатации, ремонту, монтажу, наладке, обслуживанию, проектированию систом автоматического (ав) томатизированного) управления (САУ) и противоаварийной защиты (ПА3) для взрывоопасных сред, включая оборудование во варывозащищенном исполнении", imageUrl: "/images/learning_docs/26_03_24(2).jpg", date: "2024-03-26" },
        { id: 6, title: "Свидетельство о повышении квалификации C Nº 4303412 по эксппуатации, ремонту, монтажу, наладке, обслуживанию, проектированию систом автоматического (ав) томатизированного) управления (САУ) и противоаварийной защиты (ПА3) для взрывоопасных сред, включая оборудование во варывозащищенном исполнении", imageUrl: "/images/learning_docs/26_03_24(3).jpg", date: "2024-03-26" },
        ...
        { id: 9, title: "Свидетельство о повышении квалификации CNº 4820231 по программе Обеспечение охраны труда в организации. Руководители и специалисты организаций.", imageUrl: "/images/learning_docs/13_06_25.jpg", date: "2025-06-13" },
        { id: 10, title: "Свидетельство о повышении квалификации CNº 4820231 по программе Обеспечение охраны труда в организации. Руководители и специалисты организаций.", imageUrl: "/images/learning_docs/21_07_23.jpg", date: "2023-07-21" },
    ];
